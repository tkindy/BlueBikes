...
get_googlemap(
  ...
  ggmap() +
  geom_segment(data=trip_durations_top,aes(x = `start station longitude`, y = `start station latitude`, xend = `end station longitude`, yend = `end station latitude`, color = as.numeric(`trip_duration`), size=`count`), alpha=0.5) +
